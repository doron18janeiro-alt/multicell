...
export const normalizeVehicleProfileInput = (
  ...
  condition: normalizeVehicleCondition(
    input.vehicleCondition as string | null | undefined,
  ),
  ...
  color: normalizeOptionalText(input.vehicleColor),
  mileage: parseOptionalInteger(input.vehicleMileage),
  sinisterHistory: normalizeOptionalText(input.vehicleSinisterHistory),
...
export const buildVehicleProductData = (
  ...
  return {
    ...
    vehicleCondition: vehicleProfile.condition || "SEMINOVO",
    ...
    vehicleColor: vehicleProfile.color,
    vehicleMileage: vehicleProfile.mileage,
    vehicleSinisterHistory: vehicleProfile.sinisterHistory,
